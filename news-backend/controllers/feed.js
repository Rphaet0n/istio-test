...
exports.getPosts = async (req, res, next) => {
  ...
  try {
    ...
    ///
    let params = {
      uri: 'http://news-statistics',
      // headers: req.headers,
      body: '111',
      method: 'POST'
    }
    let stat = await request(params).json;
...
exports.getPost = async (req, res, next) => {
  ...
  try {
    ...
    console.log(params);
    let reqs = await fetch('http://news-statistics', params);
    // let stat = await request(params);
    let stat = await reqs.json();
    console.log(stat);
